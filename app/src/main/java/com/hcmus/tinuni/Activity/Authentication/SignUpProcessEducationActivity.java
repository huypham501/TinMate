...
public class SignUpProcessEducationActivity extends Activity {
    ...
    private boolean isValidForm() {
        final String strTextFieldSchoolName = textFieldSchoolName.getEditText().toString();
        final String strTextFieldMajor = textFieldMajor.getEditText().toString();
        final String strTextFieldYearBegins = textFieldYearBegins.getEditText().toString();
        ...
        if (strTextFieldSchoolName.isEmpty()) {
            ...
            textFieldSchoolName.setError("Name should be from 2 - 50 characters");
    ...
    private void commitToDatabase() {
        ...
        databaseReference.setValue(hashMapUserEducation).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
